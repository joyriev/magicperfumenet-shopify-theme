...
// All products organized by brand with full details
...
const PerfumeCatalog = {
  ...
  dior: [
    {
      ...
      description: "Une interprétation raffinée et puissante de la ligne Dior Homme. Un parfum oriental boisé qui combine l'élégance de l'iris avec la sensualité du cuir et la profondeur du cèdre.",
      year: "2011",
      gender: "Homme",
      productNumbers: ["277"],
      shopifyProduct: {
    ...
    },
    {
      ...
      brand: "Dior",
      image: "https://magyx.fr/cdn/shop/files/196W_c.webp?v=1771765712&width=300",
      top_notes: ["Bergamote", "Mandarine"],
      heart_notes: ["Rose", "Jasmin", "Patchouli"],
      base_notes: ["Vanille", "Bois de santal", "Musc"],
      description: "L'interprétation la plus intense de Miss Dior. Un parfum floral oriental avec une signature ambrée.",
      year: "2022",
      gender: "Femme",
      productNumbers: ["196"],
      shopifyProduct: {
  ...
  chanel: [
    {
      ...
      description: "Le parfum légendaire qui a révolutionné l'histoire de la parfumerie. Un bouquet floral emblématique.",
      year: "1921",
      gender: "Femme",
      productNumbers: ["077"],
      shopifyProduct: {
    ...
    },
    {
      ...
      description: "Une version plus intense et profonde de Coco Mademoiselle. Une signature orientale encore plus sensuelle.",
      year: "2018",
      gender: "Femme",
      productNumbers: ["067"],
      shopifyProduct: {
    ...
    },
    {
      ...
      heart_notes: ["Rose", "Jasmin", "Ylang-Ylang"],
      base_notes: ["Patchouli", "Vanille", "Musc"],
      description: "Un parfum élégant et raffiné. Une fragrance florale pour la femme moderne et sophistiquée.",
      year: "2017",
      gender: "Femme",
      productNumbers: ["139"],
      shopifyProduct: {
  ...
  jpg: [
    ...
    },
    {
      ...
      productNumbers: ["442"],
      shopifyProduct: {
        title: "No. 442 — Senteur Inspirée Classique",
  ...
  lancome: [
    ...
    },
    {
      ...
      name: "Idôle",
      brand: "Lancôme",
      image: "https://magyx.fr/cdn/shop/files/055W_c.webp?v=1771765712&width=300",
      top_notes: ["Bergamote", "Poire"],
      heart_notes: ["Rose", "Jasmin"],
      base_notes: ["Musc", "Vanille", "Cèdre"],
      description: "Un parfum floral moderne. Une fragrance qui célèbre la féminité.",
      year: "2019",
      gender: "Femme",
      productNumbers: ["055"],
      shopifyProduct: {
        title: "No. 055— Senteur Inspirée Idole",
        url: "https://magyx.fr/products/magic-perfume-no-055w",
        price: "€11.99",
        image: "https://magyx.fr/cdn/shop/files/055W_c.webp?v=1771765712&width=300"
      }
    },
  ...
  gucci: [
    ...
    },
    {
      ...
      name: "Rush",
      brand: "Gucci",
      image: "https://magyx.fr/cdn/shop/files/167W_c.webp?v=1771765712&width=300",
      top_notes: ["Calone", "Freesia"],
      heart_notes: ["Rose", "Jasmin"],
      base_notes: ["Patchouli", "Vétiver"],
      description: "Un parfum audacieux et sensuel. Une fragrance qui crée une addiction.",
      year: "1999",
      gender: "Femme",
      productNumbers: ["167"],
      shopifyProduct: {
        title: "No. 167— Senteur Inspirée Rush",
        url: "https://magyx.fr/products/magic-perfume-no-167w",
        price: "€11.99",
        image: "https://magyx.fr/cdn/shop/files/167W_c.webp?v=1771765712&width=300"
      }
    }
